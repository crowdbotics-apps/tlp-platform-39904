"""
Django settings for tlp_platform_39904 project.
...
ROOT_URLCONF = 'tlp_platform_39904.urls'
...
WSGI_APPLICATION = 'tlp_platform_39904.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tlp_platform_39904 API",
    "DESCRIPTION": "API documentation for tlp_platform_39904 App",
    "VERSION": "v1",
}
